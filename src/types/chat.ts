...
export type QueuedMessageStatus = 'queued' | 'running';
...
export type StreamEvent =
  ...
  | { type: 'progress'; message: string; [key: string]: unknown }
  ...
  | { type: 'session_end'; reason?: 'completed' | 'aborted' | 'error' };
...
type ToolStartStreamEvent = ToolEventIdentity & {
...
type ToolEndStreamEvent = ToolEventIdentity & {
...
type ToolOutputStreamEvent = ToolEventIdentity & {
...
export type ContentBlock = TextBlock | ToolCallBlock | PermissionBlock;
